        ...
        st.markdown(f'''
            <div style="display: flex; gap: 5px; margin-top: 15px; margin-bottom: 10px;">
                ...
                <a href="{download_url if is_dl else '#'}" target="_blank" style="flex: 3; text-decoration:none;">
                    <button style="width:100%; height:38px; border-radius:5px; border:none; background-color:{'#d9b630' if is_dl else '#d3d3d3'}; color:white; cursor:{'pointer' if is_dl else 'not-allowed'};">
